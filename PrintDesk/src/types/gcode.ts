...
export type ObjectCancellationProtocol = "marlin-m486" | "klipper";

export interface CancelableGcodeObject {
  id: string;
  name: string;
}
...
export interface ParsedGcode {
  ...
  cancelableObjects: CancelableGcodeObject[];
  objectCancellationProtocol: ObjectCancellationProtocol | null;
